...
public class PetShop {
    ...
    public void addItemsFromFile(String fileName) throws FileNotFoundException {
        ...
        while (ip.hasNext()) {
            ...
            if (name.equals("Cat")) {
                ...
                a = new Cat(ip.next(), ip.nextFloat(), ip.nextFloat());
            } else if (name.equals("Dog")) {
                a = new Dog(ip.next(), ip.nextFloat(), ip.nextFloat());
            } else if (name.equals("Octopus")) {
                a = new Octopus(ip.next(), ip.nextFloat(), ip.nextFloat());
            } else if (name.equals("Fish")) {
                a = new Fish(ip.next(), ip.nextFloat(), ip.nextFloat());
            } else if (name.equals("WormCan")) {
                a = new WormCan(ip.nextFloat(), ip.nextFloat());
            } else if (name.equals("ChowBag")) {
                a = new ChowBag(ip.nextFloat(), ip.nextFloat());
            }
    ...
    public void printSummary() {
        ...
        petSort(countPetsA, pricePetsA, countPets, pricePets,
     ...
     */
    public void petSort(int a, float b, int c, float d, 
